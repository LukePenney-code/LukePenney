...
public:
    ...
    int     distanceMapIndex(BWAPI::TilePosition tile, Grid<int> distanceMap);
    Grid<int> computeDistanceMap(const BWAPI::TilePosition& startTile);
    BWAPI::TilePosition getNatural();
};